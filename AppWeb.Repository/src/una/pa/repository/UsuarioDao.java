  ...
  +"  USUARIO.ID_USUARIO = ENDERECO.ID_USUARIO;";
    ...
    public static DadosIniciais inicioPerfil(String username, int _idUsuario) {
        ...
        String sql = "select u.id_usuario "
                ...
                + ", isnull((select count(*) from jogo_desejado jd where jd.id_usuario = u.id_usuario and id_jogo not in(select id_jogo from jogo_usuario where id_usuario = u.id_usuario)),0) as desejo "

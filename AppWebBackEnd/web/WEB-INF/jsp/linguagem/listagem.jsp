        ...
        <div id="container">
            ...
            <div id="content" class="clearfix">
                ...
                <table cellpadding="0" cellspacing="0" class="tb_list">
                    ...
                    <tbody>
                        <c:forEach items="${linguagens}" var="Linguagem" varStatus="count" >
                            ...
                            <tr class="${estiloLinha}">
                                <td>
                                    <c:out value="${Linguagem.id_linguagem}"/>
                                </td>
                                <td>
								...
								|
                                    <a href="remove.htm?id=${Linguagem.id_linguagem}" onclick="return(window.confirm('Confirma a exclusão?'))" title="Excluir">Excluir</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>

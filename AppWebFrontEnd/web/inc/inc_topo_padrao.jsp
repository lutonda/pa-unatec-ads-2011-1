...
<div id="main">
    <div style="height: 95px;">
        <ul>
            ...
            <li style="float: left; width: 123px; margin-right: 10px; border: #ececed solid 1px;"><a href="/AppWebFrontEnd/inicio/ajuda/auxilio.html" title="Posso Ajudar?">Ajuda</a></li>
    ...
    <div><span style="float:right;"><a id="btnPs3" href="javascript:void(0);">PS3</a> - <a id="btnWii" href="javascript:void(0);">WII</a> - <a id="btnXbox" href="javascript:void(0);">XBOX</a></span></div>
</div>
<%//}%>
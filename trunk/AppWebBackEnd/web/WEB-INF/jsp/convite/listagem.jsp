            ...
            <div id="content" class="clearfix">
                ...
                <table cellpadding="0" cellspacing="0" class="tb_list">
                    ...
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Assunto Convite</th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
                        <c:forEach items="${convites}" var="Convite" varStatus="count" >
                            ...
                            <tr class="${estiloLinha}">
                                <td>
                                    <c:out value="${Convite.id_convite}"/>
                                </td>
                                <td>
                                    <c:out value="${Convite.assunto}"/>
                                </td>
                                <td>
                                    <a href="editar.htm?id=${Convite.id_convite}" title="Editar">Editar</a>
								|
                                    <a href="remove.htm?id=${Convite.id_convite}" onclick="return(window.confirm('Confirma a exclusão?'))" title="Excluir">Excluir</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>

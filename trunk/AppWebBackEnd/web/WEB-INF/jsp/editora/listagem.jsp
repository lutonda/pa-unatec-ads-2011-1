                    ...
                    <tbody>
                        <c:forEach items="${editoras}" var="Editora" varStatus="count" >
                            ...
                            <tr class="${estiloLinha}">
                                <td>
                                    <c:out value="${Editora.id_editora}"/>
                                </td>
                                <td>
                                    <c:out value="${Editora.nm_editora}"/>
                                </td>
                                <td>
                                    <a href="editar.htm?id=${Editora.id_editora}" title="Editar">Editar</a>
								|
                                    <a href="remove.htm?id=${Editora.id_editora}" onclick="return(window.confirm('Confirma a exclusão?'))" title="Excluir">Excluir</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>

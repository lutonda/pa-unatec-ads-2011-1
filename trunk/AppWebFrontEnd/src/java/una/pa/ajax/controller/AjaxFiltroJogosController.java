...
public class AjaxFiltroJogosController {
    ...
    public String getListaJogos(HttpServletRequest request,
            @RequestParam int idGenero, @RequestParam String tipoFiltro, @RequestParam int qtd, @RequestParam int pagina) {

        String Itens = "";
        List<Jogo> objJogo;

        objJogo = JogoService.filtroJogosGenerico(idGenero, tipoFiltro, qtd, pagina);

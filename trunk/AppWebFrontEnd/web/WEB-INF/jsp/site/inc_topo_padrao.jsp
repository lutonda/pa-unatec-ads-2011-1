...
<div id="main">
    <div style="height: 95px;">
        <ul>
            ...
            <li style="float: left; width: 134px; margin-right: 10px; border: #ececed solid 1px;">Amigos <c:if test="${DadosIniciais.amigos_pendentes != 0}">(${DadosIniciais.amigos_pendentes})</c:if></li>
            ...
            <div>Meus Jogos | Meus Desejos<span style="float:right;">PS3 - WII - XBOX</span></div>
</div>
            ...
            <div id="content">
                <div id="sidebarleft">
                    <div class="box-nav">
                        ...
                        <ul id="nav-user">
                            <li><div style="float: left; width: 40px; margin-bottom: 6px;"><div class="box-itemcount">${DadosIniciais.trocas}</div></div><div style="padding-top: 10px; width: 150px;"><a id="btnPropFinalizadas" href="javascript:void(0);">Trocas Realizadas</a></div><div class="cb"></div></li>
                            ...
                            <li><div style="float: left; width: 40px; margin-bottom: 5px;"><div class="box-itemcount">${DadosIniciais.pontos}</div></div><div style="padding-top: 10px;">Reputação</div></li>
                            <div class="cb"></div>
                        </ul>
                        <div class="cb"></div>
                    </div>
                ...
                <div id="main">
                    <div id="usuarios" class="box-df">
                        <span id="nmUser" style="font-size: 18px; font-weight: bold;">${DadosIniciais.nm_usuario} ${DadosIniciais.nm_sobrenome}</span><span style="display: none;" id="idUser">${DadosIniciais.id_usuario}</span><span style="display: none;" id="idUserAmigo">${AmigoUsuario.id_amigo_usuario}</span><span style="display: none;" id="idUserVisitante">${IdParam}</span> <br/>
